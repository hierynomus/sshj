...
class KeyWithCertificateUnitSpec extends Specification {
    ...
    def "KeyType CertUtils checkPrincipals"() {
        ...
        !KeyType.CertUtils.matchPattern("", "aaa")
        !KeyType.CertUtils.matchPattern("aaa", "")
        !KeyType.CertUtils.matchPattern("aaa", "aaaa")
        !KeyType.CertUtils.matchPattern("aaaa", "aaa")
        KeyType.CertUtils.matchPattern("", "*")
        KeyType.CertUtils.matchPattern("a", "?")
        KeyType.CertUtils.matchPattern("aa", "a?")
        KeyType.CertUtils.matchPattern("a", "*")
        KeyType.CertUtils.matchPattern("aa", "a*")
        KeyType.CertUtils.matchPattern("aa", "?*")
        KeyType.CertUtils.matchPattern("aa", "**")
        KeyType.CertUtils.matchPattern("aa", "?a")
        KeyType.CertUtils.matchPattern("aa", "*a")
        !KeyType.CertUtils.matchPattern("ba", "a?")
        !KeyType.CertUtils.matchPattern("ba", "a*")
        !KeyType.CertUtils.matchPattern("ab", "?a")
        !KeyType.CertUtils.matchPattern("ab", "*a")
    }
}