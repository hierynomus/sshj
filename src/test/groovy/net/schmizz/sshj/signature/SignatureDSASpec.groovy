...
//    @Unroll
//    def "should convert #way ASN.1"() {
//        given:
//        def signature = new SignatureDSA()
//
//    }
//
//        @Test
...
//                Assert.assertArrayEquals(asn1, toASN1);
//            }
//        }
    ...
    def "test bigint"() {
        expect:
        new BigInteger(1, [0, 0, 0, 1, 2] as byte[]).toByteArray() == [1, 2] as byte[]
        new BigInteger(1, [0x81, 0, 0, 1, 2] as byte[]).toByteArray() == [0, 0x81, 0, 0, 1, 2] as byte[]
    }
}
