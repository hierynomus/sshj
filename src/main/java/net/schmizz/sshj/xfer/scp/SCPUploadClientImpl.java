...
public final class SCPUploadClientImpl extends AbstractSCPClient implements SCPUploadClient {

    private LocalFileFilter uploadFilter;

    SCPUploadClientImpl(SCPEngine engine) {
        super(engine);
    }

    SCPUploadClientImpl(SCPEngine engine, int bandwidthLimit) {
