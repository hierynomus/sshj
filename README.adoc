...
* FIDO/U2F security keys (`sk-ecdsa-sha2-nistp256@openssh.com`, `sk-ssh-ed25519@openssh.com`), via an SSH agent or a pluggable `SecurityKeySigner`
* SSH agent authentication over the `SSH_AUTH_SOCK` unix-domain socket
