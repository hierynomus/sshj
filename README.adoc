...
== Release history
SSHJ 0.31.0 (????-??-??)::
* Merged https://github.com/hierynomus/sshj/pulls/630[#630]: Add support for `aes128-gcm@openssh.com` and `aes256-gcm@openssh.com` ciphers
...
* Merged  https://github.com/hierynomus/sshj/pulls/595[#595]: Allow reading arbitrary length keys
* Merged  https://github.com/hierynomus/sshj/pulls/591[#591]: Allow to query SFTP extensions
* Merged  https://github.com/hierynomus/sshj/pulls/603[#603]: Add method to create Stateful SFTP client
* Merged  https://github.com/hierynomus/sshj/pulls/605[#605]: Use Daemon threads to avoid blocking JVM shutdown
* Merged  https://github.com/hierynomus/sshj/pulls/606[#606]: Always use the JCERandom RNG by default
* Merged  https://github.com/hierynomus/sshj/pulls/609[#609]: Clear passphrase after use to prevent security issues
* Merged  https://github.com/hierynomus/sshj/pulls/618[#618]: Fix localport of DirectConnection for use with OpenSSH > 8.0
* Merged  https://github.com/hierynomus/sshj/pulls/619[#619]: Upgraded BouncyCastle to 1.66
* Merged  https://github.com/hierynomus/sshj/pulls/622[#622]: Send 'ext-info-c' with KEX algorithms
* Merged  https://github.com/hierynomus/sshj/pulls/623[#623]: Fix transport encoding of `nistp521` signatures
* Merged  https://github.com/hierynomus/sshj/pulls/607[#607]: Fix mathing pubkeys to key algorithms
* Merged  https://github.com/hierynomus/sshj/pulls/602[#602]: Fix RSA certificate key determination
